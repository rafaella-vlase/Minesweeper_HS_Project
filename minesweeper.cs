    ...
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            for (i = 1; i <= x; i++)
                for (j = 1; j <= y; j++)
                {
                    ...
                    b[i, j].BackColor = Color.BlueViolet;
        ...
        private void bt(int x0, int y0)
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                xx = x0 + dx[i];
                yy = y0 + dy[i];
                if (xx >= 1 && yy <= y && xx <= x && yy >= 1 && B[xx, yy] == 0 && M[xx, yy] == 0)
                {
                    B[xx, yy] = 1;
                    b[xx, yy].BackColor = Color.White;
                    b[xx, yy].Text = "0";
                    M[xx, yy] = -2;  //-2 citit
                    bt(xx, yy);
                }
            ...
            void button_MouseClick(object sender, MouseEventArgs e)
            {
                ...
                if(e.Button==MouseButtons.Left)
                {
                    ...
                    else
                    {
                        ...
                        if (e.Button == MouseButtons.Left && c == 0)
                        {
                            scantot();
                            golescB();
                            bt(i, j);
